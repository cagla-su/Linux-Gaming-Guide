...
- To run games using your dedicated <img width="16" height="30" alt="image" src="https://github.com/user-attachments/assets/bea33d54-3560-4d14-a706-6a4edef4e8a6" /> **AMD** GPU, use the following command:
```
DRI_PRIME=1
```

...
# Başlamadan Önce
> [!NOTE]
> - <img width="16" height="25" alt="mc" src="https://github.com/user-attachments/assets/b48ac714-01b3-4aaf-bb00-348e811eb0d5" /> Minecraft'ın **iki sürümü** vardır, bu sürümler <img width="16" height="25" alt="image" src="https://github.com/user-attachments/assets/84503488-e733-4547-8113-97e9f3efc9db" /> **Java** ve <img width="16" height="25" alt="mc" src="https://github.com/user-attachments/assets/b48ac714-01b3-4aaf-bb00-348e811eb0d5" /> **Bedrock** sürümleridir.
> - Linux, <img width="16" height="25" alt="image" src="https://github.com/user-attachments/assets/84503488-e733-4547-8113-97e9f3efc9db" /> **Java sürümünü** doğrudan destekler.
> - **Bedrock** sürümüne gelince, Linux, **Pocket Edition (<img width="16" height="25" alt="image-removebg-preview(1)" src="https://github.com/user-attachments/assets/cec27060-1d67-48e1-8f29-a3a5b639fde8" /> Android)** sürümünü çalıştırabilir. Ancak Linux, PC için sunulan **Bedrock Edition'ı çalıştıramaz**.
> - Bunun sebebi **Bedrock Edition'ın (PC)** bir **UWP** uygulaması olmasıdır, ki UWP uygulamaları Linux'ta <img width="10" height="25" alt="image" src="https://github.com/user-attachments/assets/465d07fc-c39e-4193-8182-f82eb9fa3464" /> WINE aracılığıyla bile **çalışamazlar**.
> - Bu yüzden Linux'ta **Bedrock Edition'ı** oynamanın tek yolu <img width="16" height="25" alt="image-removebg-preview(1)" src="https://github.com/user-attachments/assets/cec27060-1d67-48e1-8f29-a3a5b639fde8" /> **Android sürümünü** oynamaktır.
> - Bu aynı zamanda oyunu **<img width="16" height="25" alt="image" src="https://github.com/user-attachments/assets/abd68b9b-79ab-4062-a28c-54edff49e54e" /> Google Play Store'dan satın almış olmanız gerektiği** anlamına gelir.
>   - Eğer **Pocket Edition** oynamak isterseniz [Flathub](https://flathub.org/en/apps/io.mrarm.mcpelauncher)'dan yükleyip oynamaya başlayabilirsiniz.
...
- Ardından, `En fazla hafıza paylaşımı` değerini değiştirin.
> [!WARNING]
> - Eğer oyuna **RAM'inizin yarısı kadar bir değer atarsanız yüksek performans** alacağınıza dair bir söylenti vardır fakat bu **yanlıştır** çünkü:

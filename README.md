...
DRI_PRIME=1
```
 - To run games using your <img width="16" height="16" alt="nvidia" src="https://github.com/user-attachments/assets/a014cd5a-3542-441b-ba82-84ec73061764" /> **NVIDIA** GPU, use the following command:
```
